...
var Popup = function () {
  function Popup(options) {
    ...
    this.options = (0, _assign2.default)({}, Popup.DEFAULT, options);
  ...
  (0, _createClass3.default)(Popup, [{
    ...
    value: function init() {
      ...
      var styleValue = 'width: ' + this.width + 'px; height: ' + this.height + 'px;';
    ...
    value: function render() {
      var tpl = '<div class="header"> ' + this.title + ' </div>' + ('<div class="content"> ' + this.content + ' </div>') + '<div class="footer">' + ('<button class="open btn">' + this.open.name) + ('<button class="close btn">' + this.close.name) + '</div>';
    ...
    value: function bindEvents() {
      ...
      this.fork.addEventListener('click', function () {
        _this.toggle();
      }, false);
...
var App = function () {
  ...
  (0, _createClass3.default)(App, [{
    ...
    key: 'renderButton',
    value: function renderButton(option) {
